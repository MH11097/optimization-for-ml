"""Damped Newton v2 - Ridge Regression

=== PHIÊN BẢN: DAMPED NEWTON + RIDGE ===
...
class BoToiUuHoaNewtonGiamTocRidge:
    """
    Bộ tối ưu hóa Newton giảm tốc cho Ridge Regression (L2 regularization)
