...
- Preprocessing decisions: `notes/02_preprocessing/transformation_explanations.md`
  _Ghi chú: Những hiểu biết này được áp dụng trực tiếp vào các quyết định tiền xử lý và chiến lược thiết kế đặc trưng. Mọi con số và phân tích đều dựa trên dữ liệu thực tế từ 2.78 triệu xe trong dataset._
