...
1. **BFGS**: Broyden, C.G. (1970). _The convergence of a class of double-rank minimization algorithms_
2. **L-BFGS**: Liu, D.C. & Nocedal, J. (1989). _On the limited memory BFGS method for large scale optimization_
3. **SR1**: Conn, A.R., Gould, N.I. & Toint, P.L. (2000). _Trust Region Methods_

### Recommended Textbooks

- Nocedal, J. & Wright, S.J. (2006). _Numerical Optimization_ (2nd ed.) - **The definitive reference**
- Boyd, S. & Vandenberghe, L. (2004). _Convex Optimization_ - **Theoretical foundations**
- Dennis, J.E. & Schnabel, R.B. (1996). _Numerical Methods for Unconstrained Optimization_
