...
def main():
    ...
    # Khởi tạo model với adaptive learning rate được điều chỉnh
    model = SGDModel(
        learning_rate=0.001,        # Base learning rate thấp hơn để ổn định
        so_epochs=100,
        random_state=42,
        ...
        lr_increase_factor=1.05,    # Điều chỉnh nhẹ hơn để ổn định
        lr_decrease_factor=0.8      # Điều chỉnh nhẹ hơn để ổn định
    )
