...
1. Shor, N. Z. (1985). _Minimization Methods for Non-Differentiable Functions_. Springer-Verlag.
2. Polyak, B. T. (1987). _Introduction to Optimization_. Optimization Software.
3. Bertsekas, D. P. (1999). _Nonlinear Programming_. Athena Scientific.

### Modern Developments

- Nesterov, Y. (2004). _Introductory Lectures on Convex Optimization_. Kluwer Academic Publishers.
- Boyd, S., & Vandenberghe, L. (2004). _Convex Optimization_. Cambridge University Press.
- Beck, A. (2017). _First-Order Methods in Optimization_. SIAM.

### Specialized Topics

- Kiwiel, K. C. (1985). _Methods of Descent for Nondifferentiable Optimization_. Springer-Verlag.
- Hiriart-Urruty, J. B., & Lemaréchal, C. (1993). _Convex Analysis and Minimization Algorithms_. Springer-Verlag.
