...
1. Robbins, H., & Monro, S. (1951). A stochastic approximation method. _The Annals of Mathematical Statistics_, 22(3), 400-407.
2. Bottou, L. (2010). Large-scale machine learning with stochastic gradient descent. _Proceedings of COMPSTAT_.
3. Kingma, D. P., & Ba, J. (2014). Adam: A method for stochastic optimization. _arXiv preprint arXiv:1412.6980_.

### Advanced Topics

- Johnson, R., & Zhang, T. (2013). Accelerating stochastic gradient descent using predictive variance reduction. _NIPS_.
- Defazio, A., Bach, F., & Lacoste-Julien, S. (2014). SAGA: A fast incremental gradient method. _NIPS_.
- Dean, J., et al. (2012). Large scale distributed deep networks. _NIPS_.
