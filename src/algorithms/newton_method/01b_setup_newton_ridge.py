#!/usr/bin/env python3
"""
Setup script for Pure Newton Method - Ridge
Group 01b: Pure Newton với Ridge loss function
...
def main():
    ...
    print("=" * 60)
    print("NEWTON METHOD - GROUP 01B: PURE NEWTON RIDGE")
    print("=" * 60)
    
    # Load data
    X_train, X_test, y_train, y_test = load_du_lieu()
    
    # Khởi tạo Pure Newton model với Ridge regularization
    model = NewtonModel(
        ham_loss='ridge',
