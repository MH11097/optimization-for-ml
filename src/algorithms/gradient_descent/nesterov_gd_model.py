#!/usr/bin/env python3
"""
NesterovGDModel - Class cho Nesterov Accelerated Gradient Descent
...
class NesterovGDModel:
    """
    Nesterov Accelerated Gradient Descent Model với hỗ trợ nhiều loss functions
    ...
    def fit(self, X, y):
        ...
        """
        print(f"🚀 Training Nesterov Accelerated Gradient Descent - {self.ham_loss.upper()}")
    ...
    def evaluate(self, X_test, y_test):
        ...
        in_ket_qua_danh_gia(metrics, self.training_time, 
                           f"Nesterov Accelerated Gradient Descent - {self.ham_loss.upper()}")
        return metrics
    ...
    def save_results(self, ten_file, base_dir="data/03_algorithms/gradient_descent"):
        ...
        results_data = {
            "algorithm": f"Nesterov Accelerated Gradient Descent - {self.ham_loss.upper()}",
            ...
            "convergence_analysis": {
                ...
                "convergence_rate": "superlinear",  # Nesterov có thể đạt superlinear convergence
                "loss_reduction_ratio": float(self.loss_history[0] / self.loss_history[-1]) if len(self.loss_history) > 0 else 1.0,
                "velocity_contribution": "accelerated_convergence_with_lookahead"
            },
            "algorithm_specific": {
                "gradient_descent_type": "nesterov_accelerated",
                "momentum_coefficient": self.momentum,
                "step_size_constant": True,
                "acceleration_used": True,
                "nesterov_lookahead": True,
                "momentum_description": "Nesterov acceleration with look-ahead gradient computation"
            }
        }
    ...
    def plot_results(self, X_test, y_test, ten_file, base_dir="data/03_algorithms/gradient_descent"):
        ...
        ve_du_doan_vs_thuc_te(y_test, y_pred_test, 
                             title=f"Nesterov AGD {self.ham_loss.upper()} - Predictions vs Actual",
        ...
        ve_duong_dong_muc_optimization(
            ...
            title=f"Nesterov AGD {self.ham_loss.upper()} - Optimization Path",
