...
def main():
    ...
    # Group 03c: Optimal Config + Square Root Decay Learning Rate  
    model = SGDModel(
        ...
        learning_rate_schedule='sqrt_decay'  # Square root decay
    )
    ...
    print(f"\nLR Scheduling SGD - Square Root Decay completed!")
