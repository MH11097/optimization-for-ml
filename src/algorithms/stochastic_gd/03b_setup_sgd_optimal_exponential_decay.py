...
def main():
    ...
    # Group 03b: Optimal Config + Exponential Decay Learning Rate
    model = SGDModel(
        learning_rate=0.01,  # Base learning rate (will decay)
        so_epochs=100,
        random_state=42,
        ...
        learning_rate_schedule='exponential_decay',  # Exponential decay
    ...
    print(f"\nLR Scheduling SGD - Exponential Decay completed!")
