...
def main():
    ...
    # Group 05c: Optimal Config + Both Shuffling Options
    model = SGDModel(
        ...
        shuffle_each_epoch=True,  # Enhanced shuffling
        randomize_each_epoch=True  # Full randomization with replacement
    )
    ...
    print(f"\nAdvanced SGD - Batch 64, Step 0.001, Both Shuffle & Randomize completed!")
