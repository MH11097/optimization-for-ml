"""Damped Newton v1 - OLS (Ordinary Least Squares)

=== PHIÊN BẢN: DAMPED NEWTON + OLS ===

HÀM LOSS: OLS (MSE thuần túy)
Công thức: L(w) = (1/2n) * Σ(y_i - ŷ_i)²
Không có regularization term
...
class BoToiUuHoaNewtonGiamTocOLS:
    """
    Bộ tối ưu hóa Newton giảm tốc cho OLS (Ordinary Least Squares)
