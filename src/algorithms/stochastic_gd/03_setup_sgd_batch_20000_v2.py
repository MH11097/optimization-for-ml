...
def main():
    """Chạy Mini-batch Stochastic Gradient Descent"""
    print("STOCHASTIC GRADIENT DESCENT - MINI-BATCH (32) SETUP")
    ...
    model = SGDModel(
        ...
        so_epochs=100,
        random_state=42,
        batch_size=20000,  # Batch size lớn hơn cho ổn định
        ham_loss='ols'
    )
