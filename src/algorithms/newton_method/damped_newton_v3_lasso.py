"""Damped Newton v3 - Lasso Regression (Approximate)

=== PHIÊN BẢN: DAMPED NEWTON + LASSO ===
...
class BoToiUuHoaNewtonGiamTocLasso:
    """
    Bộ tối ưu hóa Newton giảm tốc cho Lasso Regression (L1 approximation)
