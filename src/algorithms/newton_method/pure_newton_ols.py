...
def main():
    """Chạy Pure Newton Method v1 cho OLS"""
    print("PURE NEWTON METHOD V1 - OLS SETUP")
    
    # Setup results directory
    results_dir = Path("data/03_algorithms/newton_method/pure_newton_v1_ols")
    ...
    in_ket_qua_danh_gia(metrics, training_time, "Pure Newton Method v1 - OLS")
    
    # Save results.json
    print("   Lưu kết quả vào results.json...")
    results_data = {
        "algorithm": "Pure Newton Method v1 - OLS",
    ...
    ve_duong_hoi_tu(loss_history, gradient_norms, 
                    title="Pure Newton Method v1 OLS - Convergence Analysis",
    ...
    ve_du_doan_vs_thuc_te(y_test, y_pred_test, 
                         title="Pure Newton Method v1 OLS - Predictions vs Actual",
    ...
    ve_duong_dong_muc_optimization(
        ...
        X=X_train, y=y_train,
        title="Pure Newton Method v1 OLS - Optimization Path",
